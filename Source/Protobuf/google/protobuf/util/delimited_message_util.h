...
bool PROTOBUF_API SerializeDelimitedToFileDescriptor(const MessageLite& message, int file_descriptor);

bool PROTOBUF_API SerializeDelimitedToOstream(const MessageLite& message, ostream* output);
...
bool PROTOBUF_API ParseDelimitedFromZeroCopyStream(MessageLite* message, io::ZeroCopyInputStream* input, bool* clean_eof);

bool PROTOBUF_API ParseDelimitedFromCodedStream(MessageLite* message, io::CodedInputStream* input, bool* clean_eof);
...
// stream would cause them to be merged. A delimited message is a varint
// encoding the message size followed by a message of exactly that size.
bool PROTOBUF_API SerializeDelimitedToZeroCopyStream(const MessageLite& message, io::ZeroCopyOutputStream* output);

bool PROTOBUF_API SerializeDelimitedToCodedStream(const MessageLite& message, io::CodedOutputStream* output);
